...
class HrCnssEmployeeLine(models.Model):
    ...
    ssnid = fields.Char(related='employee_id.ssnid', string="SSN No", help="Social Security Number", store=True)
    registration_number = fields.Char(related='employee_id.registration_number', store=True)
    pro_category = fields.Char(related='employee_id.pro_category', string="Professional category",
                               help="Professional category", store=True)
