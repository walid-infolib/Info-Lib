...
class TestEvatXmlReport(TestAccountReportsCommon):
    ...
    def test_evat_xml_report_dates_year(self):
        ...
        options = self._init_options(report, fields.Date.to_date('2020-01-01'), fields.Date.to_date('2021-12-31'))

        # Different years, invalid (error raised)
        with self.assertRaises(UserError):
            report._l10n_no_set_time_interval(options)
    ...
    def test_evat_xml_report_dates_months(self):
        report = self.env['account.generic.tax.report']
        options = self._init_options(report, fields.Date.to_date('2021-01-01'), fields.Date.to_date('2021-11-01'))
    ...
    def test_evat_xml_report_tax_values(self):
        report = self.env['account.generic.tax.report']
        options = self._init_options(report, fields.Date.to_date('2021-01-01'), fields.Date.to_date('2021-01-31'))
