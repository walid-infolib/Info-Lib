...
class HrPayslip(models.Model):
    ...
    def _get_worked_day_lines(self, domain=None, check_out_of_contract=True):
        ...
        ############################################################
        if self.struct_id.type_id.wage_type == 'monthly' and self.struct_id.type_id.default_work_entry_days:
            ...
            for worked in res:
                ...
                elif work_entry_type_id == self.struct_id.type_id.default_work_entry_type_id:
